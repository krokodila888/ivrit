...
function CardsHolder() {
  ...
  function getText() {
    if (cards && cards.length === 0) return 'У вас еще нет сохраненных карточек';
  ...
  return (
    ...
    <section className="cardsHolder__content" id="cardsHolder">
      ...
      <div>
      {showCards && cards && cards.length !== 0 && cards.map((item, i) => (
      ...
      {showCards && cards && cards.length !== 0 && editItem && 
